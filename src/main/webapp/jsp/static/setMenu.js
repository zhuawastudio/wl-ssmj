function setMenu(){
	if(window.sessionStorage.getItem('role') != '管理员'){
		...
		$('#side-menu').append('<li><a href="javascript:void(0);" data-toggle="collapse" data-target="#app_dr"><div class="pull-left"><i class="zmdi zmdi-apps mr-20"></i><span class="right-nav-text">个人中心</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a><ul id="app_dr" class="collapse collapse-level-1"><li><a href="' + baseUrl + 'jsp/modules/center/updatePassword.jsp" onclick="navClick(this);return false;">修改密码</a></li></ul></li>');
